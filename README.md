...
5. Put the two decade counter clock/reset pins on the same AVR port, so both could be reset or clocked in on operation (saving ~62ns) (see also [Syonara circuit diagram V2](design_ideas/Syonara%20Circuit%20Diagram%20V2.png) for an illustration, and idea #10).
